  ...
  puzzles: [
    {
      ...
      type: 'text-input',
      title: '교수의 첫 번째 수수께끼',
      prompt: `책상 위 쪽지에 교수의 필체로 쓰여 있다.\n교수는 왜 이런 암호를 남겼을까?\n\n"소심한 <strong>핀</strong>은 혼자 박혀 있지만 <strong>펜</strong>은 모두에게 말을 걸고,\n<strong>언덕</strong>은 묵묵히 서 있지만 <strong>ㅇㅇ</strong>은 시끄럽게 온 세상을 뒤흔든다."\n\nㅇㅇ에 들어갈 말은?`,
      answer: '지옥',
